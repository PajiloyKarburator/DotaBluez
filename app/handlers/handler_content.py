...
CONTENT_DESCRIPTION_TEXTS = {
    "prime": (
        "💎 <b>Prime</b>\n\n"
        "Для тех, кто хочет играть чаще, искать быстрее и получать больше"
        "на хороший матч.\n\n"
        "Что даёт:\n"
        "— 30 анкет за поиск!\n"
        "— 30 мин до обновления поиска!\n"
        "— приоритет в подборе\n"
        "— до 3 разных игр в анкете!\n"
        "— 💎 статус в профиле\n\n"
        "Хороший выбор, если ты регулярно играешь и хочешь заметный буст."
    ),
    "gold": (
        "👑 <b>Gold</b>\n\n"
        "Статус Gold уже говорит сам за себя, с ним у тебя открываются все возможности! "
        "Что даёт:\n"
        "— поиск без ограничений!\n"
        "— максимальный приоритет в подборе\n"
        "— неограниченное количество разных игр в анкете\n"
        "— 1 Второй Шанс!\n"
        "— 👑 статус в профиле\n\n"
        "Почувствуй себя королем и пользуйся всеми доступными благами."
    ),
    "oracle": (
        "🔮 <b>Oracle</b>\n\n"
        ...
        "Дает больше уверенности перед матчем"
    ...
    "second_chance": (
        ...
        "Что даёт:\n"
        "— сброс рейтинга\n"
        "Это шанс восстановить репутацию"
    ...
    "refresh": (
        ...
        "Что даёт:\n"
        "— мгновенное обновление попыток для поиска\n"
